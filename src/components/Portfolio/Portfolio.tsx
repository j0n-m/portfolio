          ...
          <div className="project-list grid grid-cols-1 grid-rows-2 place-content-center py-10 gap-20">
            <div className="project-card row-start-1 lg:grid grid-cols-2">
              <div className="object-cover flex flex-col mx-auto justify-center max-w-[75%] lg:w-full">
                <img
                  src="https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-desk/v1734339342/newsrss-site_whhyan"
                  srcSet="
                  https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-tab/v1734339342/newsrss-site_whhyan 600w,
                  https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-desk/v1734339342/newsrss-site_whhyan 1024w,
                  "
                  alt="News RSS website image preview"
              ...
              <div className="col-start-2 flex flex-col p-4 md:py-10 md:px-20 lg:p-6 items-center justify-center">
                <p className="text-center font-bold text-xl">News RSS</p>
                <p className="text-center text-gray-600 mt-6">
                  A website that delivers you the latest news from your favorite
                  sources. News RSS uses the power of RSS to retrieve up-to-date
                  news from any sources you provide. Specifically, this
                  full-stack application allows users to login to an account and
                  subscribe to news sources, read, and save articles for later.
                </p>
            ...
            <div className="project-card row-start-2 lg:grid grid-cols-2 ">
              <div className="object-cover flex flex-col mx-auto justify-center max-w-[75%] lg:w-full">
                <img
                  src="https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-desk/cyberden-site-shot_yvurhn"
                  srcSet="
                  https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-tab/cyberden-site-shot_yvurhn 600w,
                  https://res.cloudinary.com/dgio3wn9w/image/upload/t_portfolio-desk/cyberden-site-shot_yvurhn 1024w,
                  "
              ...
              <div className="col-start-1 flex flex-col p-4 md:py-10 md:px-20 lg:p-6 items-center justify-center lg:order-[-1]">
            ...
            <div className="project-card row-start-3 grid lg:grid-cols-2">
              <div className="flex flex-col p-4 md:py-10 md:px-20 lg:p-6 items-center justify-center order-1">
